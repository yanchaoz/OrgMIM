...
def STUNet_base(in_channels, num_classes, enable_deep_supervision=True):
...
def STUNet_small(in_channels, num_classes, enable_deep_supervision=True):
    conv_kernel_sizes, pool_op_kernel_sizes = _common_kernels()
    return STUNet(
        in_channels,
        num_classes,
...
def STUNet_large(in_channels, num_classes, enable_deep_supervision=True):
    conv_kernel_sizes, pool_op_kernel_sizes = _common_kernels()
    return STUNet(
        in_channels,
        num_classes,
