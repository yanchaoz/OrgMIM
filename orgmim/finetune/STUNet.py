...
import torch
from .load_weights import _download_pretrained_ckpt, _load_stunet_pretrained_encoder_from_ckpt
...
def STUNet_base(
    ...
    if pretrain:
        ...
        _load_stunet_pretrained_encoder_from_ckpt(model, ckpt)
